...
function defaultAction($pdo) {
    ...
    /* Detecte l'activation du bouton Dupliquer et retourne en parametre le trajet à dupliquer */
    if (isset($_GET['dupl'])) {
        global $valeurTrajet;
        $valeurTrajet = getTrajetById($pdo, (htmlspecialchars($_GET["dupl"])));
    } else {
        global $valeurTrajet;
        $valeurTrajet = ["idTrajet"=>"",
            "villeDep"=>"",
            "villeEtape"=>"",
            "villeArr"=>"",
            "heureDep"=>"",
