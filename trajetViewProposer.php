                ...
                <form id="formProposer" action="trajetViewProposer.php?&action=propose"  method="post">
                    <div class="tab">
                        ...
                        <div class="form-group">
                            ...
                            <?php } else if (isset($_GET['dupl'])){ ?>
                                <input type="text" class="form-control" name="villeDep"
                                       placeholder="Ville de départ" required value=<?=$valeurTrajet['villeDep'];?>>
                            <?php } else {?>
                        ...
                        <div class="form-group">
                            ...
                            <?php } else if (isset($_GET['dupl'])){ ?>
                                <input type="text" class="form-control" name="villeArr" id="villeArr"
                                       placeholder="Ville d'arrivée" required value=<?=$valeurTrajet['villeArr'];?>>
                            <?php } else { ?>
                                <input type="text" class="form-control" name="villeArr" id="villeArr"
                    ...
                    <div class="tab">
                        ...
                        <div class="form-group">
                            ...
                            <?php } else if (isset($_GET['dupl'])){ ?>
                                <input type="text" class="form-control" name="nbPlaces" id="nbPlace"
                                       placeholder="Nombre de places" required value=<?=$valeurTrajet['nbPassagers'];?>>
                            <?php } else { ?>
                                <input type="text" class="form-control" name="nbPlaces" id="nbPlace"
                        ...
                        <div class="form-group">
                            <?php if(isset($messageErreur) && (!$messageErreur['prixValide'])) { ?>
                                ...
                                <input type="text" class="form-control" name="prix" id="prix"
                                       placeholder="Prix (indicatif)" value=<?=$valeurTrajet['prix'];?>>
                            <?php } else { ?>
                                <input type="text" class="form-control" name="prix" id="prix"
                        ...
                        <textarea class="form-control" name="commentaires"
                                  placeholder="Commentaires (lieu de départ, d'arrivée précis,...)" value=<?=$valeurTrajet['commentaires'];?>></textarea>
                        </div>
                    </div>
